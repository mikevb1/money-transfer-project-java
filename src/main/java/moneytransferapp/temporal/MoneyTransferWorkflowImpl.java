...
public class MoneyTransferWorkflowImpl implements MoneyTransferWorkflow {
    private static final double MIN_AMOUNT_FOR_APPROVAL = 1000.00;
    ...
    public void transfer(TransactionDetails transaction) {
        ...
        double amountToTransfer = transaction.getAmountToTransfer();

        System.out.printf("[%s] Processing transaction: €%.2f from %s to %s.\n", transactionReferenceId,
                amountToTransfer, sourceAccountId, destinationAccountId);
        ...
        try {
            ...
            System.out.printf("[%s] Withdrawal of €%.2f from account %s failed.\n", transactionReferenceId,
                    amountToTransfer, sourceAccountId);
            System.out.flush();
        ...
        // Stage 2: If the transaction amount is more than 1000, wait for manual
        // approval
